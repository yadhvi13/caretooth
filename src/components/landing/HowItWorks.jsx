      ...
      <div className='relative'>
        ...
        >
          ...
          <motion.div variants={cardVariants} className='relative group'>
            <div className='relative bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/50 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/20 hover:-translate-y-2'>
              {/* STEP NUMBER */}
              ...
              {/* ICON */}
              <div className='w-20 h-20 bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl flex items-center justify-center mx-auto group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 mb-6'>
          ...
          <motion.div variants={cardVariants} className="relative group">
            <div className="relative bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/50 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/20 hover:-translate-y-2">
              ...
              <div className="flex flex-wrap gap-2 justify-center">
                ...
                <span className="px-3 py-1 bg-primary/10 text-primary text-xs rounded-full">Follow-up Care</span>
              </div>
            </div>
          </motion.div>
        </motion.div>
      ...
      >
        <Link href="/book">
          <Button size="lg" className="group bg-primary hover:bg-primary/90 shadow-lg shadow-primary/20 hover:shadow-primary/40 transition-all duration-300">
            <ArrowRightIcon className="mr-2 size-5 group-hover:translate-x-1 transition-transform" />
            Get started now
          </Button>
        </Link>
      </motion.div>
